...
router.post('/register', authRateLimiter, validateBody(userRegistrationSchema), asyncHandler(async (req, res) => {
...
router.post('/login', authRateLimiter, validateBody(userLoginSchema), asyncHandler(async (req, res, next) => {
...
router.post('/forgot-password', sensitiveOperationsRateLimiter, validateBody(passwordResetRequestSchema), asyncHandler(async (req, res) => {
...
router.post('/reset-password', sensitiveOperationsRateLimiter, validateBody(passwordResetSchema), asyncHandler(async (req, res) => {
...
router.post('/change-password', sensitiveOperationsRateLimiter, validateBody(z.object({
