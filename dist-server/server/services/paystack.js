 ...
 */
export const initializeTransaction = async (amount, email, reference, callbackUrl, metadata) => {
    try {
 ...
 */
export const createPlan = async (name, amount, interval, description) => {
    try {
 ...
 */
export const createSubscription = async (customerEmail, planCode) => {
    try {
 ...
 */
export const getSubscription = async (idOrCode) => {
    try {
 ...
 */
export const processWebhook = (signature, body) => {
    try {
...
router.get('/subscriptions/:idOrCode', async (req, res) => {
    try {
...
router.post('/subscriptions/:code/cancel', async (req, res) => {
    try {
...
router.post('/webhook', (req, res) => {
    try {
        ...
        const body = req.body;
        const eventData = processWebhook(signature, body);
