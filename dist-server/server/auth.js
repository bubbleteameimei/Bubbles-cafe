...
export function setupAuth(app) {
    ...
    app.post("/api/auth/forgot-password", sensitiveOperationsRateLimiter, async (req, res) => {
        try {
            let { email } = req.body;
            if (!email) {
    ...
    app.get("/api/auth/test-metadata", async (req, res) => {
        try {
    ...
    app.post("/api/auth/reset-password", sensitiveOperationsRateLimiter, async (req, res) => {
        try {
