 ...
 */
export function csrfTokenToLocals(req, res, next) {
 ...
 */
export function validateCsrfToken(options = {}) {
    ...
    return (req, res, next) => {
        ...
        if (req._csrfBypassApproved === true) {
        ...
        if (ignorePaths.some(path => apiPath === path ||
            relPath === path ||
            endpointPath === path ||
