...
import { Bug, Book, Building, ChevronDown, Compass, FileText, Home, Link2 as Link, LineChart, Lock, Mail, Monitor, Palette, Scroll, Settings, Shield, Star, Type, Users, User, UserCircle, Eye, HelpCircle, MessageSquare, Bell } from "lucide-react"
...
export function SidebarNavigation({ onNavigate }: { onNavigate?: () => void }) {
  ...
  const submenuItemClass = "text-[hsl(var(--sidebar-foreground))] hover:text-[hsl(var(--sidebar-accent-foreground))] data-[active=true]:text-[hsl(var(--sidebar-accent-foreground))] data-[active=true]:font-medium transition-all duration-100 ease-out text-sm font-medium py-2 px-3 pr-12 whitespace-nowrap overflow-hidden min-h-[36px] flex items-center -mb-1 rounded-sm hover:bg-[hsl(var(--sidebar-accent))] data-[active=true]:bg-[hsl(var(--sidebar-accent))] data-[active=true]:font-medium transition-all duration-150 ease-out text-sm font-medium py-1.5 px-2 whitespace-nowrap overflow-hidden min-h-[36px] flex items-center -mb-1 rounded-sm border-l-2 border-transparent hover:border-l-primary/20 focus:outline-none focus:ring-0 focus-visible:ring-0";

  // Sidebar Menu Button component with enhanced styling and click handling
