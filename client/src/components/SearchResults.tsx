      ...
      {searchResults.map(post => {
        ...
        const ThemeIconCmp = (() => {
          ...
          switch (slug) {
            ...
            case 'knife': return ForkKnife; case 'fork-knife': case 'forkknife': case 'utensils': return ForkKnife; case 'trees': case 'tree': return Trees; case 'castle': return Castle; case 'bug': return Bug;
