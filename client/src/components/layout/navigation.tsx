      ...
      >
        <div className="main-header flex items-center justify-between h-14 px-4">
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              <SheetTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-12 w-12 rounded-lg border border-border/20 bg-background/20 supports-[backdrop-filter]:bg-background/10 hover:bg-background/30 supports-[backdrop-filter]:hover:bg-background/20 text-foreground transition-colors transition-transform duration-200 ease-out active:scale-95"
          ...
          <div className="relative flex items-center space-x-2">
            ...
            <NotificationIcon className="h-12 w-12 rounded-lg border border-border/20 bg-background/20 supports-[backdrop-filter]:bg-background/10 hover:bg-background/30 supports-[backdrop-filter]:hover:bg-background/20 text-foreground transition-colors transition-transform duration-200 ease-out active:scale-95" />
