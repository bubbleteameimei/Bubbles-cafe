          ...
          <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto">
            ...
            >
              <Button 
                ...
                className="group w-full px-6 py-3 bg-gradient-to-r from-slate-600 via-slate-700 to-gray-700 hover:from-slate-500 hover:via-slate-600 hover:to-gray-600 text-white shadow-lg transition-all duration-300 hover:shadow-xl font-sans font-medium text-lg"
              >
                Browse Stories
                <motion.div
                  animate={{ 
            ...
            >
              <Button 
                ...
                className="group w-full px-6 py-3 bg-[#444444] hover:bg-[#505050] text-white shadow-lg transition-all duration-300 hover:shadow-xl font-sans font-medium text-lg"
              >
                Try Again
                <motion.div
                  animate={{ 
        ...
        <div className="relative min-h-screen overflow-x-hidden flex flex-col home-page">
          ...
          <div className="relative z-10 flex flex-col items-center justify-start pt-2 sm:pt-4 md:pt-6 lg:pt-8 pb-6 sm:pb-8 md:pb-10 lg:pb-12 text-center w-full min-h-screen">
            ...
            <div className="space-y-5 sm:space-y-6 md:space-y-8 mb-8 sm:mb-10 md:mb-12 lg:mb-16">
              ...
              <div>
                <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 w-full max-w-3xl mx-auto">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  >
                    <Button
                      ...
                      className="group relative text-xl sm:text-2xl md:text-3xl h-14 sm:h-16 md:h-18 lg:h-20 w-full bg-gradient-to-r from-slate-600 via-slate-700 to-gray-700 hover:from-slate-500 hover:via-slate-600 hover:to-gray-600 text-white shadow-xl backdrop-blur-sm font-sans font-medium transition-all duration-300 hover:shadow-2xl hover:shadow-slate-500/25 active:scale-95"
                    >
                      Browse Stories
                      <motion.div
                        animate={{ 
                  ...
                  >
                    <Button
                      ...
                      className="group relative text-xl sm:text-2xl md:text-3xl h-14 sm:h-16 md:h-18 lg:h-20 w-full bg-[#444444] dark:bg-[#333333] hover:bg-[#505050] dark:hover:bg-[#3f3f3f] text-white shadow-xl backdrop-blur-sm font-sans font-medium transition-all duration-300 hover:shadow-2xl hover:shadow-gray-500/25 active:scale-95"
                    >
                      Start Reading
                      <motion.div
                        animate={{ 
              ...
              {posts.length > 0 && (
                <div className="mt-4 sm:mt-6 md:mt-8 lg:mt-10 text-center space-y-2 sm:space-y-3 md:space-y-4">
                  <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-white uppercase tracking-wider font-sans" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.9)' }}>Latest Story</p>
                  <div 
                    onClick={() => setLocation('/reader')} 
