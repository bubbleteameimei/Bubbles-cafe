        ...
        >
          ...
          <div ref={heroRef} className="relative z-20 container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-start pt-0 pb-10 sm:pb-12 md:pb-16 lg:pb-20 text-center w-full min-h-screen">
            ...
            >
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-0 w-full max-w-xl mx-auto px-4 sm:rounded-xl sm:overflow-hidden sm:shadow-lg sm:ring-1 sm:ring-border/10">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  >
                    <Button
                      ...
                      className="group relative w-full h-14 bg-[#1A1A1A] hover:bg-[#2A2A2A] text-white sm:shadow-none sm:hover:shadow-none shadow-lg backdrop-blur-sm font-sans font-medium text-lg transition-all duration-300 active:scale-95 rounded-lg sm:rounded-none flex items-center justify-center px-5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
