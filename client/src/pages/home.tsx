          ...
          <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto">
            ...
            >
              <Button 
                ...
                className="group w-full px-6 py-3 bg-gradient-to-r from-slate-600 via-slate-700 to-gray-700 hover:from-slate-500 hover:via-slate-600 hover:to-gray-600 text-white shadow-lg transition-all duration-300 hover:shadow-xl font-sans font-normal text-lg"
              >
                Browse Stories
                <motion.div
                  animate={{ 
            ...
            >
              <Button 
                ...
                className="group w-full px-6 py-3 bg-[#444444] hover:bg-[#505050] text-white shadow-lg transition-all duration-300 hover:shadow-xl font-sans font-normal text-lg"
              >
                Try Again
                <motion.div
                  animate={{ 
                ...
                <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 w-full max-w-3xl mx-auto">
                  ...
                  >
                    <Button
                      ...
                      className="group relative text-xl sm:text-2xl md:text-3xl h-14 sm:h-16 md:h-18 lg:h-20 w-full bg-gradient-to-r from-slate-600 via-slate-700 to-gray-700 hover:from-slate-500 hover:via-slate-600 hover:to-gray-600 text-white shadow-xl backdrop-blur-sm font-sans font-normal transition-all duration-300 hover:shadow-2xl hover:shadow-slate-500/25 active:scale-95"
                    >
                      Browse Stories
                      <motion.div
                        animate={{ 
                  ...
                  >
                    <Button
                      ...
                      className="group relative text-xl sm:text-2xl md:text-3xl h-14 sm:h-16 md:h-18 lg:h-20 w-full bg-[#444444] dark:bg-[#333333] hover:bg-[#505050] dark:hover:bg-[#3f3f3f] text-white shadow-xl backdrop-blur-sm font-sans font-normal transition-all duration-300 hover:shadow-2xl hover:shadow-gray-500/25 active:scale-95"
                    >
                      Start Reading
                      <motion.div
                        animate={{ 
