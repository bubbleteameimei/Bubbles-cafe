...
function formatLogMessage(level, module, message, details) {
    return {
...
async function log(level, module, message, details) {
...
export function createLogger(moduleName) {
    return {
        debug: (message, details) => log('debug', moduleName, message, details),
        info: (message, details) => log('info', moduleName, message, details),
        warn: (message, details) => log('warn', moduleName, message, details),
        error: (message, details) => log('error', moduleName, message, details)
    };
}
/**
 ...
 */
export function captureError(error, module, context) {
