...
function canonicalizeThemeKey(input: string | undefined | null): string {
  ...
  const SYNONYMS: Record<string, string> = {
    ...
    // “*_HORROR” suffix normalization
    'PSYCHOLOGICAL_HORROR': 'PSYCHOLOGICAL',
    'SUPERNATURAL_HORROR': 'SUPERNATURAL',
    'EXISTENTIAL_HORROR': 'EXISTENTIAL',
    'COSMIC_HORROR': 'COSMIC',
    'TECHNOLOGICAL_HORROR': 'TECHNOLOGICAL',
    'GOTHIC_HORROR': 'GOTHIC',
    'UNCANNY_HORROR': 'UNCANNY',
    'FOLK_HORROR_HORROR': 'FOLK_HORROR', // defensive
    'PARASITE_HORROR': 'PARASITE',
    'CANNIBALISM_HORROR': 'CANNIBALISM',
    'VEHICULAR_HORROR': 'VEHICULAR',
    'CURSED_OBJECT_HORROR': 'CURSED_OBJECT',
    'URBAN_HORROR_HORROR': 'URBAN_HORROR',
    'CONTAGION_HORROR': 'CONTAGION',
    'MONSTER_HORROR': 'MONSTER',
    'DEATH_HORROR': 'DEATH',
    'SLASHER_HORROR': 'SLASHER',
    'PSYCHOPATH_HORROR': 'SLASHER',
